...
import {Button, UncontrolledPopover, PopoverHeader, PopoverBody, Progress } from 'reactstrap';

class R052_ReactstrapPropgress extends Component{
    constructor (props) {
        super(props);
...
export default R052_ReactstrapPropgress;