...
import R038 from "./page/part2/R038";
import R039 from "./page/part2/R039";
import R040 from "./page/part2/R040";
...
import R050 from "./page/part2/R050";
import R051 from "./page/part2/R051";
import R052 from "./page/part2/R052";
import R053 from "./page/part2/R053";
import R054 from "./page/part2/R054";
import R055 from "./page/part2/R055";
import R056 from "./page/part2/R056";
import R057 from "./page/part2/R057";
import R058 from "./page/part2/R058";
import R059 from "./page/part2/R059";
import R060 from "./page/part2/R060";
import R061 from "./page/part2/R061";
import R062 from "./page/part2/R062";
import R063 from "./page/part2/R063";
import R064 from "./page/part2/R064";
import R065 from "./page/part2/R065";
import R066 from "./page/part3/R066";
import R067 from "./page/part3/R067";
import R068 from "./page/part3/R068";
import R069 from "./page/part3/R069";
import R070 from "./page/part3/R070";
import R071 from "./page/part3/R071";
import R072 from "./page/part3/R072";
import R073 from "./page/part3/R073";
import R074 from "./page/part3/R074";
...
import R085 from "./page/part3/R085";
import R086 from "./page/part3/R086";
import R087 from "./page/part3/R087";
import R091 from "./page/part3/R091";
import R092 from "./page/part3/R092";
import R093 from "./page/part3/R093";
import R094 from "./page/part3/R094";
import R095 from "./page/part3/R095";
import R096 from "./page/part4/R096";
import R099 from "./page/part4/R099";
import R100 from "./page/part4/R100";
import R101 from "./page/part4/R101";
import R102 from "./page/part4/R102";
import R103 from "./page/part4/R103";
    ...
    return(
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/R038" element={<R038/>}></Route>
                <Route path="/R039" element={<R039/>}></Route>
                <Route path="/R040" element={<R040/>}></Route>
                ...
                <Route path="/R050" element={<R050/>}></Route>
                <Route path="/R051" element={<R051/>}></Route>
                <Route path="/R052" element={<R052/>}></Route>
                <Route path="/R053" element={<R053/>}></Route>
                <Route path="/R054" element={<R054/>}></Route>
                <Route path="/R055" element={<R055/>}></Route>
                <Route path="/R056" element={<R056/>}></Route>
                <Route path="/R057" element={<R057/>}></Route>
                <Route path="/R058" element={<R058/>}></Route>
                <Route path="/R059" element={<R059/>}></Route>
                <Route path="/R060" element={<R060/>}></Route>
                <Route path="/R061" element={<R061/>}></Route>
                <Route path="/R062" element={<R062/>}></Route>
                <Route path="/R063" element={<R063/>}></Route>
                <Route path="/R064" element={<R064/>}></Route>
                <Route path="/R065" element={<R065/>}></Route>
                <Route path="/R066" element={<R066/>}></Route>
                <Route path="/R067" element={<R067/>}></Route>
                <Route path="/R068" element={<R068/>}></Route>
                <Route path="/R069" element={<R069/>}></Route>
                <Route path="/R070" element={<R070/>}></Route>
                <Route path="/R071" element={<R071/>}></Route>
                <Route path="/R072" element={<R072/>}></Route>
                <Route path="/R073" element={<R073/>}></Route>
                <Route path="/R074" element={<R074/>}></Route>
                ...
                <Route path="/R085" element={<R085/>}></Route>
                <Route path="/R086" element={<R086/>}></Route>
                <Route path="/R087" element={<R087/>}></Route>
                <Route path="/R091" element={<R091/>}></Route>
                <Route path="/R092" element={<R092/>}></Route>
                <Route path="/R093" element={<R093/>}></Route>
                <Route path="/R094" element={<R094/>}></Route>
                <Route path="/R095" element={<R095/>}></Route>
                <Route path="/R096" element={<R096/>}></Route>
                <Route path="/R099" element={<R099/>}></Route>
                <Route path="/R100" element={<R100/>}></Route>
                <Route path="/R101" element={<R101/>}></Route>
                <Route path="/R102" element={<R102/>}></Route>
                <Route path="/R103" element={<R103/>}></Route>
